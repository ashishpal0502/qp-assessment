package com.grocerybooking.grocerybooking.config;
...
//        UserDetails ashish= User.builder().username("ashish").password(passwordEncoder().encode("password")).roles("USER").build();
